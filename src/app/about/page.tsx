...
export default function AboutPage() {
  return (
    <>
      <section className="border-b border-violet-100 bg-gradient-to-br from-[#0b1220] via-indigo-950 to-[#0b1220] px-4 py-16 text-white sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-indigo-200/80">About</p>
      ...
      <SectionShell id="values">
        ...
        <ul className="mt-12 grid gap-6 sm:grid-cols-2">
          {values.map((v) => (
            <li
              key={v.title}
              className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-violet-200"
            >
      ...
      <SectionShell surface="muted" id="why">
        ...
        />
        <div className="mt-10 rounded-3xl border border-indigo-100 bg-gradient-to-br from-white to-indigo-50/50 p-8 sm:p-10">
      ...
      <SectionShell id="leadership">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-8 text-slate-600">
            <p className="text-sm font-semibold uppercase tracking-wide text-violet-700">Founder spotlight</p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
            <h3 className="font-display text-xl font-bold text-slate-900">Leadership commitments</h3>
